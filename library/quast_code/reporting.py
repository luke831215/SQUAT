...
####################################################################################
    ...
    order = [NAME, CONTIGS__FOR_THRESHOLDS, TOTALLENS__FOR_THRESHOLDS, CONTIGS, LARGCONTIG, TOTALLEN, REFLEN, ESTREFLEN, GC, REFGC,
             N25, NG25, N50, NG50, N75, NG75, L25, LG25, L50, LG50, L75, LG75, L80, LG80, L90, LG90, L99, LG99, MISASSEMBL, MISCONTIGS, MISCONTIGSBASES,
    ...
    GAGE_N25 = 'Not corrected N25'
    GAGE_N50 = 'Not corrected N50'
    GAGE_N75 = 'Not corrected N75'
    ...
    GAGE_CORN25 = 'Corrected N25'
    GAGE_CORN50 = 'Corrected N50'
    GAGE_CORN75 = 'Corrected N75'

    # content and order of metrics in GAGE report (<quast_output_dir>/gage_report.txt, .tex, .tsv)
    gage_order = [NAME, GAGE_NUMCONTIGS, GAGE_MINCONTIG, GAGE_MAXCONTIG, GAGE_N25, GAGE_N50, GAGE_N75, GAGE_GENOMESIZE, GAGE_ASSEMBLY_SIZE,
                  ...
                  GAGE_CORN25, GAGE_CORN50, GAGE_CORN75]
    ...
    grouped_order = [
        ('Genome statistics', [MAPPEDGENOME, DUPLICATION_RATIO, AVE_READ_SUPPORT, GENES, OPERONS, LARGALIGN, TOTAL_ALIGNED_LEN,
                               NG25, NG50, NG75, NA25, NA50, NA75, NGA25, NGA50, NGA75, LG25, LG50, LG75, LG80, LG90, LG99, LA25, LA50, LA75, LGA25, LGA50, LGA75,]),
        ...
        ('Statistics without reference', [CONTIGS, CONTIGS__FOR_THRESHOLDS, LARGCONTIG, TOTALLEN, TOTALLENS__FOR_THRESHOLDS,
                                          N25, N50, N75, L25, L50, L75, L80, L90, L99, GC,]),
    ...
    quality_dict = {
        Quality.MORE_IS_BETTER:
            [LARGCONTIG, TOTALLEN, TOTALLENS__FOR_THRESHOLDS, TOTALLENS__FOR_1000_THRESHOLD, TOTALLENS__FOR_10000_THRESHOLD,
             ...
             N25, NG25, N50, NG50, N75, NG75, NA25, NGA25, NA50, NGA50, NA75, NGA75,
             MAPPEDGENOME, AVE_READ_SUPPORT, GENES, OPERONS, PREDICTED_GENES_UNIQUE, PREDICTED_GENES],
        Quality.LESS_IS_BETTER:
            [L25, LG25, L50, LG50, L75, LG75, L80, LG80, L90, LG90, L99, LG99,
             ...
             LA25, LGA25, LA50, LGA50, LA75, LGA75, DUPLICATION_RATIO, INDELS, INDELSERROR, MISMATCHES, SUBSERROR,
