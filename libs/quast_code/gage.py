...
def do(ref_fpath, contigs_fpaths, output_dirpath):
    ...
    metrics = ['Total units', 'Min', 'Max', 'N25', 'N50', 'N75', 'Genome Size', 'Assembly Size', 'Chaff bases',
               ...
               'Total units', 'BasesInFasta', 'Min', 'Max', 'N25', 'N50', 'N75']
    metrics_in_reporting = [reporting.Fields.GAGE_NUMCONTIGS, reporting.Fields.GAGE_MINCONTIG, reporting.Fields.GAGE_MAXCONTIG, 
                            reporting.Fields.GAGE_N25, reporting.Fields.GAGE_N50, reporting.Fields.GAGE_N75,
                            ...
                            reporting.Fields.GAGE_MAXCORCOTING, reporting.Fields.GAGE_CORN25, reporting.Fields.GAGE_CORN50, reporting.Fields.GAGE_CORN75]
    ...
    for i, contigs_fpath in enumerate(contigs_fpaths):
        ...
        for line in logfile_out:
            if metrics[cur_metric_id] in line:
                if (metrics[cur_metric_id].startswith('N25') or metrics[cur_metric_id].startswith('N50') or metrics[cur_metric_id].startswith('N75')):
