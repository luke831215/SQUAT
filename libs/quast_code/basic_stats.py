...
def do(ref_fpath, contigs_fpaths, output_dirpath, results_dir):
    ...
    logger.info('  Calculating N25 N50 and L50...')
    ...
    for id, (contigs_fpath, lengths_list, number_of_Ns) in enumerate(zip(contigs_fpaths, lists_of_lengths, numbers_of_Ns)):
        ...
        n25, l25 = N50.N50_and_L50(lengths_list, 25)
        n75, l75 = N50.N50_and_L50(lengths_list, 75)
        n80, l80 = N50.N50_and_L50(lengths_list, 80)
        n90, l90 = N50.N50_and_L50(lengths_list, 90)
        n99, l99 = N50.N50_and_L50(lengths_list, 99)
        ng25, lg25 = None, None
        ng75, lg75 = None, None
        ng99, lg99 = None, None
        if reference_length:
            ng25, lg25 = N50.NG50_and_LG50(lengths_list, reference_length, 25)
            ng75, lg75 = N50.NG50_and_LG50(lengths_list, reference_length, 75)
            ng80, lg80 = N50.NG50_and_LG50(lengths_list, reference_length, 80)
            ng90, lg90 = N50.NG50_and_LG50(lengths_list, reference_length, 90)
            ng99, lg99 = N50.NG50_and_LG50(lengths_list, reference_length, 99)
        ...
        report.add_field(reporting.Fields.N25, n25)
        report.add_field(reporting.Fields.L25, l25)
        report.add_field(reporting.Fields.N75, n75)
        report.add_field(reporting.Fields.L75, l75)
        report.add_field(reporting.Fields.N80, n80)
        report.add_field(reporting.Fields.L80, l80)
        report.add_field(reporting.Fields.N90, n90)
        report.add_field(reporting.Fields.L90, l90)
        report.add_field(reporting.Fields.N99, n99)
        report.add_field(reporting.Fields.L99, l99)
        if reference_length and not qconfig.is_combined_ref:
            report.add_field(reporting.Fields.NG25, ng25)
            report.add_field(reporting.Fields.LG25, lg25)
            report.add_field(reporting.Fields.NG75, ng75)
            report.add_field(reporting.Fields.LG75, lg75)
            report.add_field(reporting.Fields.NG80, ng80)
            report.add_field(reporting.Fields.LG80, lg80)
            report.add_field(reporting.Fields.NG90, ng90)
            report.add_field(reporting.Fields.LG90, lg90)
            report.add_field(reporting.Fields.NG99, ng99)
            report.add_field(reporting.Fields.LG99, lg99)
